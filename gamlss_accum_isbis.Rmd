...
<div class="footer">Twitter: #isbis, @harlanh</div>
...
```{r simdata_plot, echo=FALSE, fig.height=3, fig.width=3}
...
```{r likelihood_concept, echo=FALSE, fig.height=2.5, fig.width=4, fig.align="center"}
